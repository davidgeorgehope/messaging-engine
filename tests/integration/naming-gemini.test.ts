...
const TOPIC = "CaseFlow is Acme's workflow automation engine that coordinates approvals, escalations, and handoffs across customer operations";
const DOMAIN_INFO = 'Customer Operations / Workflow Automation / Case Management / SaaS platform';
